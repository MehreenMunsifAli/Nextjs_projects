...
#### Shadcn UI: 
Beautifully designed tailwindcss components that you can copy and paste into your application.
#### Vercel: 
...
#### components/count-down.tsx:
manages the entire functionality of the project